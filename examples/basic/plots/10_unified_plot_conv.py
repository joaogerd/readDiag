...
"""
Uso:
  python 10_unified_plot_conv.py <diag_conv_path> [var] [kx] [param]
"""
if __name__ == "__main__":
    ...
    try:
        ax = p.plot(varName=var, kx=kx, param=param, cmap="coolwarm")
        out = ensure_outdir() / f"10_unified_conv_{var}_kx{kx}_{param}.png"
